...
<html lang="en">
  ...
  <body style="overflow-x: hidden;">
    <nav class="navbar navbar-expand-lg ">
        ...
        <div class="collapse navbar-collapse" style="margin-right: 10%; text-align: center;" id="navlinks">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item px-3 active border-bottom border-5 border-dark">
    ...
    <section style="margin-left: 10%;">
        ...
        <h1 class="mt-5 border-bottom border-5 border-dark" style="font-weight: 1000; display: inline-block;">COBRAS</h1>
